...
import { CcAddonDeleteEvent, CcAddonNameChangeEvent, CcAddonTagsChangeEvent } from './cc-addon-admin-new.events.js';

/**
 * @typedef {import('./cc-addon-admin-new.types.js').AddonAdminState} AddonAdminState
 ...
 * @typedef {import('./cc-addon-admin-new.types.js').AddonAdminStateSaving} AddonAdminStateSaving
 * @typedef {import('../cc-input-text/cc-input-text.events.js').CcTagsChangeEvent} CcTagsChangeEvent
 * @typedef {import('lit').PropertyValues<CcAddonAdminNew>} CcAddonAdminPropertyValues
 ...
 * @cssdisplay block
 */
export class CcAddonAdminNew extends LitElement {
...
window.customElements.define('cc-addon-admin-new', CcAddonAdminNew);
