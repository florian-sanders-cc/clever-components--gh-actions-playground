...
import './cc-addon-admin-new.js';

export default {
  tags: ['autodocs'],
  title: '🛠 Addon/<cc-addon-admin-new>',
  component: 'cc-addon-admin-new',
};
...
/**
 * @typedef {import('./cc-addon-admin-new.js').CcAddonAdminNew} CcAddonAdmin
 * @typedef {import('./cc-addon-admin-new.types.js').AddonAdminStateLoaded} AddonAdminStateLoaded
 * @typedef {import('./cc-addon-admin-new.types.js').AddonAdminStateLoading} AddonAdminStateLoading
 * @typedef {import('./cc-addon-admin-new.types.js').AddonAdminStateError} AddonAdminStateError
 * @typedef {import('./cc-addon-admin-new.types.js').AddonAdminStateUpdatingName} AddonAdminStateUpdatingName
 * @typedef {import('./cc-addon-admin-new.types.js').AddonAdminStateUpdatingTags} AddonAdminStateUpdatingTags
 * @typedef {import('./cc-addon-admin-new.types.js').AddonAdminStateDeleting} AddonAdminStateDeleting
 */
